...
compute_logic_wrapper #(
  ...
  .m_axi_dram_awid    (m_axi_compute_logic_awid),
  .m_axi_dram_awaddr  (m_axi_compute_logic_awaddr),
  .m_axi_dram_awqos   (m_axi_compute_logic_awqos),
  .m_axi_dram_awlen   (m_axi_compute_logic_awlen),
  .m_axi_dram_awsize  (m_axi_compute_logic_awsize),
  .m_axi_dram_awburst (m_axi_compute_logic_awburst),
  .m_axi_dram_awcache (m_axi_compute_logic_awcache),
  .m_axi_dram_awprot  (m_axi_compute_logic_awprot),
  .m_axi_dram_awvalid (m_axi_compute_logic_awvalid),
  .m_axi_dram_awready (m_axi_compute_logic_awready),
  .m_axi_dram_wdata   (m_axi_compute_logic_wdata),
  .m_axi_dram_wstrb   (m_axi_compute_logic_wstrb),
  .m_axi_dram_wlast   (m_axi_compute_logic_wlast),
  .m_axi_dram_wvalid  (m_axi_compute_logic_wvalid),
  .m_axi_dram_wready  (m_axi_compute_logic_wready),
  .m_axi_dram_awlock  (m_axi_compute_logic_awlock),
  .m_axi_dram_bid     (m_axi_compute_logic_bid),
  .m_axi_dram_bresp   (m_axi_compute_logic_bresp),
  .m_axi_dram_bvalid  (m_axi_compute_logic_bvalid),
  .m_axi_dram_bready  (m_axi_compute_logic_bready),
  .m_axi_dram_arid    (m_axi_compute_logic_arid),
  .m_axi_dram_araddr  (m_axi_compute_logic_araddr),
  .m_axi_dram_arlen   (m_axi_compute_logic_arlen),
  .m_axi_dram_arsize  (m_axi_compute_logic_arsize),
  .m_axi_dram_arburst (m_axi_compute_logic_arburst),
  .m_axi_dram_arcache (m_axi_compute_logic_arcache),
  .m_axi_dram_arprot  (m_axi_compute_logic_arprot),
  .m_axi_dram_arvalid (m_axi_compute_logic_arvalid),
  .m_axi_dram_arready (m_axi_compute_logic_arready),
  .m_axi_dram_rid     (m_axi_compute_logic_rid),
  .m_axi_dram_rdata   (m_axi_compute_logic_rdata),
  .m_axi_dram_rresp   (m_axi_compute_logic_rresp),
  .m_axi_dram_rlast   (m_axi_compute_logic_rlast),
  .m_axi_dram_rvalid  (m_axi_compute_logic_rvalid),
  .m_axi_dram_rready  (m_axi_compute_logic_rready),
  .m_axi_dram_arlock  (m_axi_compute_logic_arlock),
  .m_axi_dram_arqos   (m_axi_compute_logic_arqos),
