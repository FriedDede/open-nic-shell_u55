...
package snitch_cluster_pkg;
  ...
  localparam int unsigned NrCores = 1;
  ...
  localparam int unsigned NarrowIdWidthIn = 4;
  ...
  localparam int unsigned Hive [NrCores] = '{0};
  ...
  function automatic snitch_pma_pkg::rule_t [snitch_pma_pkg::NrMaxRules-1:0] get_cached_regions();
    ...
    // cache from 0x8000_0000 to 0xffff_ffff (2gb) for each core (will se if we need more) 
    // TODO: important: don't cache timers, clint, plic or peripherals
    // this is actually an instruction cache so maybe we can cache all
    cached_regions[0] = '{base: 64'h80000000, mask: 64'hffffffff80000000};
    cached_regions[1] = '{base: 64'h00000000, mask: 64'hffffffffffff0000};
  ...
  localparam snitch_pma_pkg::snitch_pma_t SnitchPMACfg = '{
      ...
      ExecuteRegion: get_cached_regions(),
      default: 0
  };
  ...
  localparam snitch_ssr_pkg::ssr_cfg_t [3-1:0] SsrCfgs [1] = '{
  ...
  localparam addr_t    	 CfgClusterBaseAddr = (64'h0);
...
module snitch_cluster_wrapper (
  ...
  input  logic [63:0]                            cluster_base_addr_i,
  ...
  localparam int unsigned NumIntOutstandingLoads [1] = '{1};
  localparam int unsigned NumIntOutstandingMem [1] = '{4};
  localparam int unsigned NumFPOutstandingLoads [1] = '{4};
  localparam int unsigned NumFPOutstandingMem [1] = '{4};
  localparam int unsigned NumDTLBEntries [1] = '{1};
  localparam int unsigned NumITLBEntries [1] = '{1};
  localparam int unsigned NumSequencerInstr [1] = '{16};
  localparam int unsigned NumSsrs [1] = '{3};
  localparam int unsigned SsrMuxRespDepth [1] = '{4};

  // Snitch cluster under test.
  snitch_cluster #(
    .PhysicalAddrWidth (64),
    .NarrowDataWidth (64),
    .WideDataWidth (64),
