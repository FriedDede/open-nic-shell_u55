...
module kvs_subsystem_old 
import metadata_pkg::*;
import kvs_pkg::*;
#(
  parameter int                     DATA_WIDTH      = kvs_pkg::DATA_WIDTH,     
  parameter int                     MAX_NODES       = kvs_pkg::MAX_NODES,      
  parameter int                     BUCKET_SIZE     = kvs_pkg::NODE_IP,        
  parameter logic            [31:0] NODE_IP         = kvs_pkg::NODE_MAC,       
  parameter logic            [47:0] NODE_MAC        = kvs_pkg::BUCKET_SIZE,    
  ...
  parameter logic [63:0]            BASE_HOST_MEM   = kvs_pkg::BASE_HOST_MEM, // starts at 16GB by default
  parameter logic [63:0]            MASK_HOST_MEM   = kvs_pkg::MASK_HOST_MEM, // 16GB by defaults
