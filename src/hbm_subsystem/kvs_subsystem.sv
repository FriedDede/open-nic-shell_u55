...
hbm_interface_wrapper i_hbm(
    ...
    .S00_AXI_0_araddr                  (axi_araddr[0]),
    .S00_AXI_0_arburst                 (axi_arburst[0]),
    .S00_AXI_0_arid                    (axi_arid[0]),
    .S00_AXI_0_arlen                   (axi_arlen[0]),
    .S00_AXI_0_arready                 (axi_arready[0]),
    .S00_AXI_0_arsize                  (axi_arsize[0]),
    .S00_AXI_0_arvalid                 (axi_arvalid[0]),
    .S00_AXI_0_awaddr                  (axi_awaddr[0]),
    .S00_AXI_0_awburst                 (axi_awburst[0]),
    .S00_AXI_0_awid                    (axi_awid[0]),
    .S00_AXI_0_awlen                   (axi_awlen[0]),
    .S00_AXI_0_awready                 (axi_awready[0]),
    .S00_AXI_0_awsize                  (axi_awsize[0]),
    .S00_AXI_0_awvalid                 (axi_awvalid[0]),
    .S00_AXI_0_bid                     (axi_bid[0]),
    .S00_AXI_0_bready                  (axi_bready[0]),
    .S00_AXI_0_bresp                   (axi_bresp[0]),
    .S00_AXI_0_bvalid                  (axi_bvalid[0]),
    .S00_AXI_0_rdata                   (axi_rdata[0]),
    .S00_AXI_0_rid                     (axi_rid[0]),
    .S00_AXI_0_rlast                   (axi_rlast[0]),
    .S00_AXI_0_rready                  (axi_rready[0]),
    .S00_AXI_0_rresp                   (axi_rresp[0]),
    .S00_AXI_0_rvalid                  (axi_rvalid[0]),
    .S00_AXI_0_wdata                   (axi_wdata[0]),
    .S00_AXI_0_wlast                   (axi_wlast[0]),
    .S00_AXI_0_wready                  (axi_wready[0]),
    .S00_AXI_0_wstrb                   (axi_wstrb[0]),
    .S00_AXI_0_wvalid                  (axi_wvalid[0]),

    .S01_AXI_0_araddr                  (axi_araddr[1]),
    .S01_AXI_0_arburst                 (axi_arburst[1]),
    .S01_AXI_0_arid                    (axi_arid[1]),
    .S01_AXI_0_arlen                   (axi_arlen[1]),
    .S01_AXI_0_arready                 (axi_arready[1]),
    .S01_AXI_0_arsize                  (axi_arsize[1]),
    .S01_AXI_0_arvalid                 (axi_arvalid[1]),
    .S01_AXI_0_awaddr                  (axi_awaddr[1]),
    .S01_AXI_0_awburst                 (axi_awburst[1]),
    .S01_AXI_0_awid                    (axi_awid[1]),
    .S01_AXI_0_awlen                   (axi_awlen[1]),
    .S01_AXI_0_awready                 (axi_awready[1]),
    .S01_AXI_0_awsize                  (axi_awsize[1]),
    .S01_AXI_0_awvalid                 (axi_awvalid[1]),
    .S01_AXI_0_bid                     (axi_bid[1]),
    .S01_AXI_0_bready                  (axi_bready[1]),
    .S01_AXI_0_bresp                   (axi_bresp[1]),
    .S01_AXI_0_bvalid                  (axi_bvalid[1]),
    .S01_AXI_0_rdata                   (axi_rdata[1]),
    .S01_AXI_0_rid                     (axi_rid[1]),
    .S01_AXI_0_rlast                   (axi_rlast[1]),
    .S01_AXI_0_rready                  (axi_rready[1]),
    .S01_AXI_0_rresp                   (axi_rresp[1]),
    .S01_AXI_0_rvalid                  (axi_rvalid[1]),
    .S01_AXI_0_wdata                   (axi_wdata[1]),
    .S01_AXI_0_wlast                   (axi_wlast[1]),
    .S01_AXI_0_wready                  (axi_wready[1]),
    .S01_AXI_0_wstrb                   (axi_wstrb[1]),
    .S01_AXI_0_wvalid                  (axi_wvalid[1]),

    .S02_AXI_0_araddr                  (axi_araddr[2]),
    .S02_AXI_0_arburst                 (axi_arburst[2]),
    .S02_AXI_0_arid                    (axi_arid[2]),
    .S02_AXI_0_arlen                   (axi_arlen[2]),
    .S02_AXI_0_arready                 (axi_arready[2]),
    .S02_AXI_0_arsize                  (axi_arsize[2]),
    .S02_AXI_0_arvalid                 (axi_arvalid[2]),
    .S02_AXI_0_awaddr                  (axi_awaddr[2]),
    .S02_AXI_0_awburst                 (axi_awburst[2]),
    .S02_AXI_0_awid                    (axi_awid[2]),
    .S02_AXI_0_awlen                   (axi_awlen[2]),
    .S02_AXI_0_awready                 (axi_awready[2]),
    .S02_AXI_0_awsize                  (axi_awsize[2]),
    .S02_AXI_0_awvalid                 (axi_awvalid[2]),
    .S02_AXI_0_bid                     (axi_bid[2]),
    .S02_AXI_0_bready                  (axi_bready[2]),
    .S02_AXI_0_bresp                   (axi_bresp[2]),
    .S02_AXI_0_bvalid                  (axi_bvalid[2]),
    .S02_AXI_0_rdata                   (axi_rdata[2]),
    .S02_AXI_0_rid                     (axi_rid[2]),
    .S02_AXI_0_rlast                   (axi_rlast[2]),
    .S02_AXI_0_rready                  (axi_rready[2]),
    .S02_AXI_0_rresp                   (axi_rresp[2]),
    .S02_AXI_0_rvalid                  (axi_rvalid[2]),
    .S02_AXI_0_wdata                   (axi_wdata[2]),
    .S02_AXI_0_wlast                   (axi_wlast[2]),
    .S02_AXI_0_wready                  (axi_wready[2]),
    .S02_AXI_0_wstrb                   (axi_wstrb[2]),
    .S02_AXI_0_wvalid                  (axi_wvalid[2]),

    .S03_AXI_0_araddr                  (axi_araddr[3]),
    .S03_AXI_0_arburst                 (axi_arburst[3]),
    .S03_AXI_0_arid                    (axi_arid[3]),
    .S03_AXI_0_arlen                   (axi_arlen[3]),
    .S03_AXI_0_arready                 (axi_arready[3]),
    .S03_AXI_0_arsize                  (axi_arsize[3]),
    .S03_AXI_0_arvalid                 (axi_arvalid[3]),
    .S03_AXI_0_awaddr                  (axi_awaddr[3]),
    .S03_AXI_0_awburst                 (axi_awburst[3]),
    .S03_AXI_0_awid                    (axi_awid[3]),
    .S03_AXI_0_awlen                   (axi_awlen[3]),
    .S03_AXI_0_awready                 (axi_awready[3]),
    .S03_AXI_0_awsize                  (axi_awsize[3]),
    .S03_AXI_0_awvalid                 (axi_awvalid[3]),
    .S03_AXI_0_bid                     (axi_bid[3]),
    .S03_AXI_0_bready                  (axi_bready[3]),
    .S03_AXI_0_bresp                   (axi_bresp[3]),
    .S03_AXI_0_bvalid                  (axi_bvalid[3]),
    .S03_AXI_0_rdata                   (axi_rdata[3]),
    .S03_AXI_0_rid                     (axi_rid[3]),
    .S03_AXI_0_rlast                   (axi_rlast[3]),
    .S03_AXI_0_rready                  (axi_rready[3]),
    .S03_AXI_0_rresp                   (axi_rresp[3]),
    .S03_AXI_0_rvalid                  (axi_rvalid[3]),
    .S03_AXI_0_wdata                   (axi_wdata[3]),
    .S03_AXI_0_wlast                   (axi_wlast[3]),
    .S03_AXI_0_wready                  (axi_wready[3]),
    .S03_AXI_0_wstrb                   (axi_wstrb[3]),
    .S03_AXI_0_wvalid                  (axi_wvalid[3]),
