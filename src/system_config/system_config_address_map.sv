...
module system_config_address_map #(
  ...
  localparam C_QDMA0_CSR_BASE = 32'h14000;
...
// QDMA + QDMA BRIDGE
  ...
  assign axil_wready[C_QDMA_CSR_INDEX]              = m_axil_qdma_csr_wready;
  assign axil_bvalid[C_QDMA_CSR_INDEX]              = m_axil_qdma_csr_bvalid;
  ...
  assign axil_rresp[`getvec(2, C_QDMA_CSR_INDEX)]   = m_axil_qdma_csr_rresp[`getvec(2, 0)];
  assign m_axil_qdma_csr_rready                     = axil_rready[C_QDMA_CSR_INDEX];
