...
`endif
  ...
  system_config_address_map #(
    ...
    .m_axil_qspi_awvalid ( ),
    .m_axil_qspi_awaddr  ( ),
    .m_axil_qspi_awready ( '0),
    .m_axil_qspi_wvalid  ( ),
    .m_axil_qspi_wdata   ( ),
    .m_axil_qspi_wready  ( '0),
    .m_axil_qspi_bvalid  ( '0),
    .m_axil_qspi_bresp   ( ),
    .m_axil_qspi_bready  ( ),
    .m_axil_qspi_arvalid ( ),
    .m_axil_qspi_araddr  ( ),
    .m_axil_qspi_arready ( '0),
    .m_axil_qspi_rvalid  ( '0),
    .m_axil_qspi_rdata   ( ),
    .m_axil_qspi_rresp   ( ),
    .m_axil_qspi_rready  ( ),
    .m_axil_qspi_arprot  ( ),
  ...
  system_config_register #(
   ...
   system_management_wiz system_management_wiz_inst (
     .s_axi_aclk      (aclk[0]),                    
